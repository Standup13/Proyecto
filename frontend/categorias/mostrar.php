   ...
   <input type="checkbox" id="menu-toggle">
    <div class="sidebar">
        ...
        <div class="side-content">
            <div class="profile">
                <div class="profile-img bg-img" style="background-image: url(../../backend/img/user14.jpg)"></div>
            ...
            <div class="side-menu">
                <ul>
                    ...
                    <li>
                       <a href="../categorias/mostrar.php" class="active">
        ...
        <header>
            <div class="header-content">
                ...
                <div class="header-menu">
                    ...
                    <div class="user">
                        <div class="bg-img" style="background-image: url(../../backend/img/user14.jpg)"></div>
     ...
     <?php if(count($data)>0):?>
                        <table width="100%" id="example">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $d->idcate ?></td>
                                    <td>
                                        <div class="client">
                                           
                                            <div class="client-info">
                                                <h4><?php echo $d->nocate ?></h4>
                        ...
                        <label class="switch">
                          <input type="checkbox" id="<?=$d->idcate?>" value="<?=$d->state ?>" <?=$d->state == '1' ? 'checked' : '' ;?>/> 
                          ...
                          <span class="slider"></span>
                                    ...
                                    <td>
                                       <a title="Actualizar" href="../categorias/editar.php?id=<?php echo $d->idcate ?>" class="fa fa-pencil tooltip"></a>
